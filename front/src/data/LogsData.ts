...
export const LogsData = {
    getLogs: cache(async () => {
        ...
        return [
            {
                id: 1,
                datetime_utc: Date.parse("2023-08-10 16:52:36.72"),
                input_string: "hello",
                output_string: "world",
                total_tokens: 1,
            },
            {
                id: 2,
                datetime_utc: Date.parse("2023-08-11 10:12:45.23"),
            ...
            {
                id: 3,
                datetime_utc: Date.parse("2023-08-12 18:30:15.91"),
            ...
            {
                id: 4,
                datetime_utc: Date.parse("2023-08-13 07:05:59.14"),
            ...
            {
                id: 5,
                datetime_utc: Date.parse("2023-08-14 22:17:30.87"),
